...
`addons/fox/tools/controls-test/controls-test-view.tscn` is a training room for the
...
```gdscript
Router.openScene(preload('res://addons/fox/tools/controls-test/controls-test-view.tscn'))
```
...
(`addons/fox/tools/controls-test/controls-test-theme-data.gd`), never from a game's own
