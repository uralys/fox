...
#   extends 'res://addons/fox/components/settings/settings-screen-base.gd'
...
const _DefaultPlate := preload('res://addons/fox/components/settings/ui/settings-plate.gd')
const _DefaultToggle := preload('res://addons/fox/components/settings/ui/settings-toggle.gd')
const _DefaultVolumeBar := preload('res://addons/fox/components/settings/ui/settings-volume-bar.gd')
const _DefaultSectionLabel := preload('res://addons/fox/components/settings/ui/section-label.gd')
const _DefaultBlock := preload('res://addons/fox/components/settings/ui/settings-block.gd')
const _DefaultFooter := preload('res://addons/fox/components/settings/ui/settings-footer.gd')
const _TextLink := preload('res://addons/fox/components/settings/ui/settings-text-link.gd')
const _Chassis := preload('res://addons/fox/components/settings/ui/settings-chassis.gd')
...
const _ThemeData := preload('res://addons/fox/components/settings/data/settings-theme-data.gd')
