...
const _Responsive := preload('res://addons/fox/screens/responsive.gd')

const DEFAULT_LOGO_PATH := 'res://addons/fox/assets/splash/logo-uralys.png'
const ELECTRIC_SHADER := preload('res://addons/fox/shaders/splash-electric.gdshader')
