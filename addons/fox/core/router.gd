...
var ScreenFader = preload("res://addons/fox/components/screen-fader.tscn")
var FullscreenLoader = preload("res://addons/fox/components/fullscreen-loader.tscn")
var SettingsPopup = null
var LanguagesPopup = null
var _NavState = preload('res://addons/fox/core/nav-state.gd')
